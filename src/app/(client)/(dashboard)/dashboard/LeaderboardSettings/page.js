...
function LeaderboardContent() {
  const { settings, loading, resetSettings } = useLeaderboardSettings();
            ...
            <div className="md:sticky md:top-6 md:self-start">
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Button size="sm" variant="outline" className="border-slate-700 text-slate-300 hover:bg-slate-800" onClick={resetSettings}>
