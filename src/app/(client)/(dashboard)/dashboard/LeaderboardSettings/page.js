      ...
      <div className="flex flex-col md:flex-row gap-6">
        <div className="flex-1">
          <motion.div
            ...
            className="rounded-2xl bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 backdrop-blur-xl p-4 sm:p-6"
          >
            ...
            <div className="space-y-2 mt-4">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  readOnly
                  className="bg-slate-800/80 border-slate-700 text-amber-400 font-mono text-xs sm:text-sm"
                />
            ...
            <div className="flex gap-2 mt-4">
              <Button className="flex-1 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-sm sm:text-base">
                Save Settings
              </Button>
