...
export default function MediaTab({ settings, updateSetting, copy }) {
  ...
  const handleClearImage = () => updateImageUrl("");
  ...
  return (
    ...
    >
      <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
        <ImageIcon className="w-5 h-5 text-cyan-400" /> {copy?.sections?.media || "Alert Image / GIF"}
      </h3>
