...
export default function CategorySelector() {
  ...
  return (
    <div className="grid grid-cols-1 gap-6 p-6 xl:grid-cols-2">
      ...
      {/* SAVE */}
      <div className="col-span-1 flex justify-end xl:col-span-2">
        <button
          onClick={() => console.log(selected)}
          className="w-[200px] rounded-full bg-gradient-to-r from-green-700 to-green-500 p-3 text-lg font-medium transition hover:scale-95"
        >
          บันทึก
        </button>
      </div>
